...
| Tool | What I use it for | Link |
|---|---|---|
| **Firecrawl** | Web scraping for agents (research, lead enrichment) | https://firecrawl.dev |
| **21st.dev** | AI-generated design components | https://21st.dev |
| **OpenAI Codex CLI** | Independent code review (second opinion on PRs) | https://openai.com/codex |
| **xAI Grok** | X/Twitter firehose search (better than X's own API) | https://x.ai |

## Infrastructure

| Tool | What I use it for | Link |
|---|---|---|
| **Supabase** | Postgres + auth + storage for product DBs | https://supabase.com |
| **MongoDB** | Where document data fits better than relational | https://mongodb.com |
| **Cloudflare** | DNS + bot management + edge | https://cloudflare.com |
| **AWS SES** | Outbound email at scale | https://aws.amazon.com/ses |
| **Railway** | Quick deploys for backend services | https://railway.app |

## Productivity

| Tool | What I use it for | Link |
|---|---|---|
| **Granola** | Meeting notes / transcripts (alternative to my own Bavi setup) | https://granola.ai |
| **Linear** | Issue tracking | https://linear.app |
| **Notion** | Long-form writing, brainstorming | https://notion.so |
...
This file gets updated as my stack changes. Watch the repo (⭐ button on GitHub) for notifications.
